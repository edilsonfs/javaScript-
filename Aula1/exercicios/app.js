...
console.log(meuAnoAniversario, anoAtual) ;
...
*/
const  myAge =new Date().getFullYear() -meuAnoAniversario;
console.log(`${myAge} é a minha idade atual`)
...
console.log(`Em ${anoAtual+10}, estarei com ${myAge+10} anos.`)
