...
const js= programmingLanguage[programmingLanguage.indexOf('J')] + programmingLanguage[programmingLanguage.indexOf('S')]
console.log(js)
...
console.log(`a constante programingLanguage possui ${programmingLanguage.length} caracteres `)
...
console.log(harryPotterAuthor.substring(0,4))
...
- Exiba a "newName" no console;
*/
console.log(`O novo nome será ${newName}`)
