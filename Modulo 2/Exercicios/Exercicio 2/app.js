...
*/
// for(let z=1; z<=10; z++){
//   console.log(`Esta é a ${z}ª vez que esta frase é exibida no console.`)
// }
...
//   upperCaseCities.push(cities[a].toUpperCase())
// }
...
for(let i=0; i<arrays.length; i++){
    for(let x=0; x<arrays[i].length; x++){
      soma = soma + Number(arrays[i][x])
    }
}
console.log(arrays.flatMap())
console.log(soma)