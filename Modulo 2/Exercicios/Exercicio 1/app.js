...
*/
const my3FavoriteTVShows =['GOT','TAHM','Continental']
let sentence = my3FavoriteTVShows.join(', ').replace(', C', ' e C')
...
/*
  ...
  - Exiba no console um boolean indicando se o array de séries que você criou  
    possui 3 itens.
*/
console.log('Array de tamanho 3')
...
//todos os valores que não são falsyValues resultam em true na sua conversão. 
...
*/
const isNotAString =  typeof randomTVShow[0] !== 'string'
console.log(typeof randomTVShow[0])
